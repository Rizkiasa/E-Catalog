...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="dashboard_dosen.php">
  ...
  <div class="pagetitle">
       <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="dashboard_dosen.php">Dashboard</a></li>
              ...
              if (
                  ...
                  $data['email'] == $email
                    ...
                    if (!$result) {
                        ...
                        echo '<script>alert("Data User berhasil diubah, anda mengubah role atau email maka anda akan ke logout dari sistem, lakukan login kembali")</script>';
